...
fun LoginBody(innerPaddingValues: PaddingValues) {
    ...
    // Updated color scheme for Classic Store
    val primaryColor = PrimaryPurple // Changed from green to purple
    val backgroundColor = BackgroundLight // Changed to light pink
    val cardColor = Color.White
    val textColor = PrimaryPurpleDark // Changed to purple dark
            ...
            modifier = Modifier
                ...
                .background(
                    brush = Brush.verticalGradient(
                        colors = listOf(
                            backgroundColor,
                            Color(0xFFF3E5F5) // Light purple gradient
                        )
                    )
                )
        ) {
                ...
                Card(
                    ...
                    Column(
                        ...
                        OutlinedTextField(
                            ...
                            leadingIcon = {
                                Icon(
                                    ...
                                    contentDescription = null,
                                    tint = AccentPink // Pink for password icon
                                )
                            },
                            trailingIcon = {
                                IconButton(
                                    ...
                                    Icon(
                                        ...
                                        contentDescription = null,
                                        tint = AccentGold // Gold for visibility icon
                                    )
                                }
                            },
                        ...
                        Row(
                            ...
                            Text(
                                "Forget Password",
                                color = AccentPink, // Changed to pink
                                fontSize = 14.sp,
